...
{
    public partial class Parchasview : Form
    {
        public Parchasview()
        {
            InitializeComponent();
        ...
        private void fill()
        {
            DataTable dt = Connection_class.Selecte("Select* From ParchasView");
            _dgv1.DataSource = dt;
            _dgv1.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

        }

        private void Parchasview_Load(object sender, EventArgs e)
        {
            fill();
        }
