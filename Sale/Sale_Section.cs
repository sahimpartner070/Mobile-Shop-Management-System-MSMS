...
{
    public partial class Sale_Section : Form
    {
        public Sale_Section()
        {
            InitializeComponent();
        ...
        private void Sale_Section_Load(object sender, EventArgs e)
        {
        ...
        private void _btnsave_Click(object sender, EventArgs e)
        {
            ...
            Connection_class.Execute(@"INSERT INTO[dbo].[sale_t]
           ([sale_date]
           ,[customer_id]
           ,[paid]
           ,[balance]
     ...
     VALUES
           ('" + _time.Value.ToString() + "', '" + _combo1.SelectedValue+ "', '" + _txtPaid.Text + "', '" + _txtBlance.Text + "', '" + _txtTotalAmount.Text + "')");
            ...
            DataTable dt_id = Connection_class.Selecte("SELECT max([sale_id])FROM [dbo].[sale_t]");
            ...
            foreach(DataGridViewRow dr in _dgv1.Rows)
            {
                ...
                Connection_class.Execute(@"INSERT INTO[dbo].[sale_detail_t]
           ([sale_id]
           ,[product_id]
           ,[quntity]
           ,[unit_price]
     ...
     VALUES
           ('" + sale_id + "', '" + product_id + "', '" + qty + "', '" + unit_price + "', '" + total + "')");
            ...
            if (MessageBox.Show("Do You Want To Print Your Bill", "Qustion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        private void _txtTotalAmount_TextChanged(object sender, EventArgs e)
        {
